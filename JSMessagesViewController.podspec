Pod::Spec.new do |s|
	...
	s.homepage			= 'https://github.com/mdelete/MessagesTableViewController'
	s.social_media_url	= 'https://twitter.com/jesse_squires'
	s.license			= 'MIT'
	s.authors			= { 'Jesse Squires' => 'jesse.squires.developer@gmail.com' }
	s.source			= { :git => 'https://github.com/mdelete/MessagesTableViewController.git', :tag => s.version.to_s }
	s.platform			= :ios, '7.0'
